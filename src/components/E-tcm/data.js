...
07：00~11：00是一天里气温持续走高的一个过程，人和大自然是相互影响的，在这个时间段，太阳在逐渐高升，体内的肾气也蠢蠢欲动地受着外界的感召，如果此时能够用属于金性质的商音和属于水性质的羽音搭配比较融洽的曲子来促使肾中精气的隆
`
  },
  lung: {
    effect: '润肺',
    ...
    max: 19,
    min: 15,
    intro: `吸烟、过度疲劳、呼吸道疾病、厨房油烟、汽车尾气、滥服药物、饮食不当都是引发肺部疾病、甚至致癌的诱因。咽部溃疡疼痛、咳嗽、鼻塞、气喘、容易感冒、易出汗，都是肺不好的表现。
